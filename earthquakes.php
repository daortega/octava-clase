...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >= 6){?> style="color:#E80017;" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){?> style="color:#FF2E42;" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 4){?> style="color:#CD6B3F;" <?php }else{ ?> style="color:RGB(100, 100, 100);" <?php };?>>
